...
import ModalReportDetail from "./ModalReportDetail.jsx";
import {faStar} from "@fortawesome/free-regular-svg-icons/faStar";
import ModalRanking from "./ModalRanking.jsx";
import {faToolbox} from "@fortawesome/free-solid-svg-icons/faToolbox";
import {useNavigate} from "react-router-dom";
import ModalOutOfArea from "./ModalOutOfArea.jsx";
    ...
    useEffect(
        () => {
            ...
            L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> | Samy v-1.5.1'
            }).addTo(map.current);
